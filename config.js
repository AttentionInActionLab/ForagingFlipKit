window.config = {
  ...
  // After reaching max_points, the experiment terminates. If you don't want a limit, delete this line
  max_points: 50,  
      ...
      elements: [
        {
          ...
          amount: 25,
          points: 1,
          images: ["disk-green.svg", "disk-yellow.svg"],
        ...
        },
        {
          ...
          amount: 25,
          points: -5,
          images: ["disk-blue.svg", "disk-red.svg"],
          collectible: true
        }
      ]
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          amount: 25,
          points: -5,
          images: ["disk-yellow.svg", "disk-green.svg"],
          collectible: true
        }
      ]
    }
